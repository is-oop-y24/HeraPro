...
namespace Isu.Services
{
    public interface IIsuService
    {
        ...
        // ICourseNumber CourseNumber(short course);
    }
    ...
    public class IsuService : IIsuService
    {
        ...
        {
            if (course <= 0) throw new IsuException(IsuException.IncorrectCourseNumber);

            _courseNumbers = new (course + 1);
            for (int i = 0; i <= course; ++i)
            {
                _courseNumbers.Add(new CourseNumber());
            }
        }
